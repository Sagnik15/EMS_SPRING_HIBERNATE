...
<%@page import="ems.beans.MedicineBean"%>
...
<div id="amount">
	...
	<form>
		...
		<div><form:form action="clearcartcontroller.spring" method="post"><input type="submit" value="Commit/new purchase" class="btn"></form:form></div>
</body>
</html>