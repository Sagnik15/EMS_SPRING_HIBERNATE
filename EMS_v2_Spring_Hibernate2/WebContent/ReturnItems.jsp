...
<body>
<div id="top-div"><form:form action = "viewexpiredcontroller.spring" method="post" commandName="expProd">
...
<div><form:form action = "returnitemcontroller.spring" method="post" commandName="retItem">
