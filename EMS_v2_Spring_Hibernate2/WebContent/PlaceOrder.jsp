...
<form:form action="placeordercontroller.spring" method="post" commandName="placeordobj">
<table>
<tr><td>Order ID</td><td><input type="text" name="order_Id"  required class="text-box"></td></tr>
<tr><td>Med ID</td><td><input type="text" name="medId" required class="text-box"></td></tr>
...
<tr><td>Order Date</td><td><input type="date" name="orderDate" required class="text-box"></td></tr>
</table>
