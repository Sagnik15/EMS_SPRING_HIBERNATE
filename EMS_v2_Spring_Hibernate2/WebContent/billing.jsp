<%@page import="ems.beans.CartService"%>
<%@page import="ems.beans.BatchBean"%>
...
<body>
 ...
 %>
			...
			<form:form commandName="fetchMed"  method="post" id="form-style" action="billingcontroller.spring" >
				
				<input type="text" name="item_name" placeholder="ItemName" required class="text-box">
				 <input type="submit" value="FETCH" class="btn">

            </form:form>
			
			<br>
			 <form:form commandName="toCart" method="post" action="addtocartcontroller.spring">
	...
	<div id="buttons">
		...
		<div >
			<form:form commandName="getbill" action="getbillcontroller.spring" method="post">
